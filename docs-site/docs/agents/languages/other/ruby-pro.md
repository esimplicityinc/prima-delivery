---
sidebar_label: Ruby Pro
title: Ruby Pro
description: Write idiomatic Ruby code with metaprogramming, Rails patterns, and performance optimization. Specializes in Ruby on Rails, gem development, and testing framewo
...
```
@ruby-pro [your request here]
```

### Claude Code

```
Use ruby-pro to [describe your task]
```
