---
sidebar_label: Workflow Orchestration Patterns
title: Workflow Orchestration Patterns
description: Design durable workflows with Temporal for distributed systems. Covers workflow vs activity separation, saga patterns, state management, and determinism constra
tags: [backend, skill]
---
