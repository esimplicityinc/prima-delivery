---
sidebar_label: Startup Financial Modeling
title: Startup Financial Modeling
description: This skill should be used when the user asks to "create financial projections", "build a financial model", "forecast revenue", "calculate burn rate", "estimate 
tags: [backend, skill]
---
