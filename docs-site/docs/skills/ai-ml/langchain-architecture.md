---
sidebar_label: Langchain Architecture
title: Langchain Architecture
description: Design LLM applications using LangChain 1.x and LangGraph for agents, memory, and tool integration. Use when building LangChain applications, implementing AI ag
tags: [ai-ml, skill]
---
