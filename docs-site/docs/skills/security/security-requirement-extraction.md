---
sidebar_label: Security Requirement Extraction
title: Security Requirement Extraction
description: Derive security requirements from threat models and business context. Use when translating threats into actionable requirements, creating security user stories,
tags: [security, skill]
---
