---
sidebar_label: Visual Design Foundations
title: Visual Design Foundations
description: Apply typography, color theory, spacing systems, and iconography principles to create cohesive visual designs. Use when establishing design tokens, building sty
tags: [frontend, skill]
---
